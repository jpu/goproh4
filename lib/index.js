...
GoPro = GoPro || {};
GoPro.maxRetriesDefault = 20;
GoPro.timeoutDefault = 10000;
...
GoPro.Camera = function (options) {
    ...
    GoPro.maxRetries = options.maxRetries || GoPro.maxRetriesDefault;

    GoPro.timeout = options.timeout || GoPro.timeoutDefault;
...
GoPro.Camera.prototype.status = function (id) {
    ...
    return this._retryPromise(function (resolve, reject) {
        ...
        request.get({url, timeout: GoPro.timeout}, function (error, response, body) {
            if (!error && response.statusCode == 200) {                
                try {
...
GoPro.Camera.prototype.set = function (setting_id, setting_value) {
    ...
    return this._retryPromise(function (resolve, reject) {
        if (setting_id !== undefined && setting_value !== undefined) {
            ...
            return request.get({url, timeout: GoPro.timeout}, function (error, response, body) {
                if (!error && response.statusCode == 200) {
                    return resolve();
                }
                if (!error && response.statusCode == 500) {
